...
public class HWAlertsApp {
    public static final String PURCHASE_TOPIC_NAME = "purchase_with_joined_product-processor";
    public static final String RESULT_TOPIC = "product_quantity_alerts-processor";
    public static final long MAX_INCOME_PER_MINUTE = 3000L;
    public static final String STATE_STORE_NAME2 = "state-store2";
    ...
    public static Topology buildTopology(SchemaRegistryClient client, Map<String, String> serDeConfig) {
        ...
        var stateStoreSupplier = Stores.keyValueStoreBuilder(
                Stores.persistentKeyValueStore(
                        STATE_STORE_NAME2 // обязательно указываемя имя стора - оно нам пригодится в нашем трансформере
                ),
